    ...
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="Sorry baby, You are Banned to use me. Contact my [Support Group](https://t.me/MOVIES_PROVIDE2).",
        ...
        await bot.send_message(
            chat_id=cmd.from_user.id,
            text="ꜱᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [ꜱᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ](https://t.me/MOVIES_PROVIDE2).",
            disable_web_page_preview=True
        )
        return 200
    return 200
